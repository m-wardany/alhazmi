    ...
    <section>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                @if (isset($award))
                    <form action="{{ route('award.update', ['award' => $award->id]) }}" method="POST"
                ...
                <div>
                    ...
                    <x-text-input id="ar_name" name="ar_name" type="text" class="mt-1 block w-full"
                        :value="old('ar_name', isset($award) ? $award->ar_name : '')" required autofocus autocomplete="ar_name" />
                ...
                <div>
                    ...
                    <x-text-input id="en_name" name="en_name" type="text" class="mt-1 block w-full"
                        :value="old('en_name', isset($award) ? $award->en_name : '')" required autofocus autocomplete="en_name" />
                ...
                <div class="form-group">
                    @if (isset($award))
                        <img src="{{ asset('storage/' . $award->image) }}" width="400">
                    @endif
