<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <x-nav-button :active="request()->routeIs('info.edit')"
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                <div>{{ __('Edit Content') }}</div>
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('info.edit', ['info' => 'ar'])">
                                {{ __('Arabic Content') }}
                            </x-dropdown-link>

                            <x-dropdown-link :href="route('info.edit', ['info' => 'en'])">
                                {{ __('English Content') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <x-nav-button :active="request()->routeIs('socialmedia')"
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                <div>{{ __('SocialMedia') }}</div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <x-responsive-nav-link :active="request()->routeIs('info.edit')">
                    {{ __('Edit Content') }}
                </x-responsive-nav-link>
            </div>

            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('info.edit', ['info' => 'ar'])">
                    {{ __('Arabic') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('info.edit', ['info' => 'en'])">
                    {{ __('English') }}
                </x-responsive-nav-link>
            </div>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <x-responsive-nav-link :active="request()->routeIs('socialmedia.edit')">
                    {{ __('Social Media') }}
                </x-responsive-nav-link>
            </div>
