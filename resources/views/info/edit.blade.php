    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <section>
                ...
                <form method="post" action="{{ route('info.update', ['info' => 'ar']) }}" class="mt-6 space-y-6">
                    @csrf
                    @method('patch')
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                        <x-text-input id="language" name="language" type="hidden" class="mt-1 block w-full"
                            :value="old('language', $info->language)" />
                        ...
                        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                            ...
                            <div>
                                ...
                                <x-text-input id="value_quality" name="value_quality" type="text"
                                    class="mt-1 block w-full" :value="old('value_quality', $info->value_quality)" required autofocus
                                    autocomplete="value_quality" />
                        ...
                        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                            <div>
                                ...
                                <x-text-input id="duty_customer" name="duty_customer" type="text"
                                    class="mt-1 block w-full" :value="old('duty_customer', $info->duty_customer)" required autofocus
                                    autocomplete="duty_customer" />
                                <x-input-error class="mt-2" :messages="$errors->get('duty_customer')" />
                            </div>

                            <div>
                                <x-input-label for="duty_products" :value="__('duty_products')" />
                                <x-text-input id="duty_products" name="duty_products" type="text"
                                    class="mt-1 block w-full" :value="old('duty_products', $info->duty_products)" required autofocus
                                    autocomplete="duty_products" />
                                <x-input-error class="mt-2" :messages="$errors->get('duty_products')" />
                            </div>

                            <div>
                                <x-input-label for="duty_markets" :value="__('duty_markets')" />
                                <x-text-input id="duty_markets" name="duty_markets" type="text"
                                    class="mt-1 block w-full" :value="old('duty_markets', $info->duty_markets)" required autofocus
                                    autocomplete="duty_markets" />
                            ...
                            <div class="columns-2">
                                @for ($i = 1; $i <= 8; $i++)
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="{{ $body }}" name="{{ $body }}"
                                            type="text" class="mt-1 block w-full" :value="old('{{ $body }}', $info->$body)" required
                        ...
                        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                            ...
                            <div>
                                ...
                                <x-text-input id="integrity" name="integrity" type="text"
                                    class="mt-1 block w-full" :value="old('integrity', $info->integrity)" required autofocus
                                    autocomplete="integrity" />
